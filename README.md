...
Wave Router is designed to operate as one component within a broader agent-control system.

Authorization, identity/provenance, execution, verification, and settlement remain separate concerns from routing.

The router may evaluate and rank candidate routes, but external assurance determines whether a specific action is allowed to execute.
